...
<div class="architecture-comparison">
  <div class="arch-item">
    <h3>Neurotypical (Streamlined) Pathways</h3>
  ...
  <div class="arch-item highlighted">
    <h3>Autistic (Distributed) Pathways</h3>
    <p><strong>Now imagine a crowd carrying information together:</strong></p>
    <ul>
...
- **Neural resolution:** More neurons capturing more feature dimensions

### An Example: Processing Sound

When you engage more neurons to represent a sound:
- Neuron 1 responds to frequency
- Neuron 2 responds to timing
- Neuron 3 responds to amplitude changes
- Neuron 4 responds to harmonic structure
...
<div class="overlap-example">
  ...
  <ul>
    <li><strong>Circuit A</strong> (processing visual texture)</li>
    <li><strong>Circuit B</strong> (processing visual motion)</li>
    <li><strong>Circuit C</strong> (processing spatial layout)</li>
  </ul>
...
2. **Resource competition:** When circuits overlap, they compete for the same neurons, the same energy supplies, the same inhibitory control
...
<div class="constraints-preview">
  <div class="constraint-box">
    ...
    <ul>
      ...
      <li>✗ Stronger suppression of competing information</li>
      <li>✗ Difficulty switching between processing modes</li>
    </ul>
  </div>
