...
## Constraint 1: Enhanced Inhibition
...
<div class="effects-grid">
  <div class="effect positive">
    <strong>✓ Exceptional Focus</strong>
    <p>When you're engaged with something, you can focus with remarkable intensity. The strong inhibition blocks out distractions.</p>
  </div>
  ...
  <div class="effect negative">
    ...
    <p>Once a processing mode is established, strong inhibition locks it in. Considering alternatives requires overcoming self-generated suppression of alternative circuits.</p>
  </div>

  <div class="effect positive">
    <strong>✓ Deep Over Broad</strong>
    <p>The architecture naturally supports depth in focused domains (maintained by strong inhibition) rather than breadth across many domains simultaneously.</p>
  </div>
</div>
...
## Constraint 2: Energy Competition
...
<div class="effects-grid">
  <div class="effect positive">
    <strong>✓ Rich Processing When Available</strong>
    <p>When energy reserves are full, distributed pathways provide extraordinarily detailed, high-fidelity processing.</p>
  </div>
  ...
  <div class="effect negative">
    <strong>✗ Context-Dependent Performance</strong>
    <p>Same task, different outcomes depending on energy state. Early in the day (energy high): excellent performance. After sustained work (energy depleted): marked degradation.</p>
  </div>

  <div class="effect negative">
    <strong>✗ Progressive Degradation</strong>
    <p>As distributed processing continues, local energy depletes faster than delivery can restore it. Function degrades gradually: first flexibility, then accuracy, eventually collapse into overload.</p>
  </div>
</div>
...
<div class="phase-space">
  ...
  <div class="state-grid">
    <div class="state optimal">
      <h4>High Energy + Strong Inhibition</h4>
      <p class="state-label">(Autistic Optimal)</p>
      <ul>
        <li>✓ Distributed pathways active</li>
        <li>✓ Inhibition strong and selective</li>
        <li><strong>Result: Exceptional focused performance</strong></li>
      </ul>
    </div>

    <div class="state neurotypical">
      <h4>High Energy + Moderate Inhibition</h4>
      <p class="state-label">(Neurotypical)</p>
      <ul>
        <li>✓ Streamlined pathways efficient</li>
        <li>✓ Flexible switching available</li>
        <li><strong>Result: Good breadth, moderate depth</strong></li>
      </ul>
    </div>

    <div class="state struggling">
      <h4>Low Energy + Strong Inhibition</h4>
      <p class="state-label">(Effortful State)</p>
      <ul>
        <li>⚠ Pathways struggling</li>
        <li>⚠ Inhibition persists, creating inflexibility</li>
        <li><strong>Result: Stuck, rigid, effortful</strong></li>
      </ul>
    </div>

    <div class="state overload">
      <h4>Low Energy + Weak Inhibition</h4>
      <p class="state-label">(Overload/Collapse)</p>
      <ul>
        <li>✗ Pathways can't activate</li>
        <li>✗ Inhibition ineffective</li>
        <li><strong>Result: Neither good processing NOR good control—diffuse overwhelm</strong></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="features-list">
  <div class="feature-item">
    ...
    <p>High resolution + energy depletion + weak inhibition = sensory flooding</p>
  </div>

  <div class="feature-item">
    <strong>Executive dysfunction</strong>
    <p>Inflexible inhibition + energy reallocation failure = can't switch tasks</p>
  </div>
