...
<p class="category-description">Understanding the neural architecture that creates higher-resolution processing</p>
...
<p class="category-description">How distributed pathways and dual constraints create the autism phenotype</p>
...
<p class="category-description">Energy dynamics, overload, and recovery in distributed systems</p>
...
<p class="category-description">Empirical support and relationships to existing theories</p>
...
<p class="category-description">Clinical, educational, and therapeutic applications</p>
...
Each section page offers three reading levels accessible via tabs:
...
<div class="levels-explanation">
  ...
  <div class="level-box">
    <h4>Standard Technical</h4>
    <p>For interdisciplinary audiences. Maintains scientific rigor while remaining accessible to readers outside neuroscience. Default view.</p>
  </div>

  <div class="level-box">
    <h4>General Explanation</h4>
    <p>For autistic individuals, families, and educators. Clear language, practical focus, metaphors for complex concepts. No technical background assumed.</p>
  </div>
</div>

<div class="tip-box">
  <p><strong>Tip:</strong> Your level selection is remembered across pages, so you can browse at your preferred depth throughout the site.</p>
</div>
