...
<div class="tabset">
  ...
  <div id="tab-tech" class="tab-panel">
    ...
    <p>In distributed architecture, concurrent activation across sensory, emotional, and cognitive circuits can exceed the capacity of inhibitory systems to contain it. When activation propagates through weakly gated branches connecting associative and emotional circuits to premotor and motor cortex, the overflow manifests as spontaneous, patterned movement. This is not volitional motor planning—it is reactive propagation finding the path of least resistance when internal gating fails to suppress spread.</p>

    <p>The movements produced through this cascade are characteristically rhythmic and repetitive because motor circuits naturally form oscillatory patterns when driven by sustained input. Once initiated, these patterns persist through recurrent motor-sensory feedback loops: the movement generates proprioceptive and tactile feedback, which reactivates motor pathways, sustaining the cycle. This is neurally analogous to central pattern generators observed in locomotion and other rhythmic motor behaviors, but driven by overflow from cognitive-emotional load rather than locomotor intent.</p>
    ...
    <p>Reactive pathways are not limited to motor output. When distributed propagation forms closed loops across auditory imagery, motor simulation, and associative regions, the result can be autonomous oscillators—persistent internal experiences that run without volitional control. These include involuntary music loops (earworms that persist for hours or days), recursive thought patterns, spontaneous problem-solving that continues "in the background," and intrusive conceptual loops.</p>

    <p>These phenomena reflect the network finding stable dynamic equilibria within its own topology. When activation propagating through distributed branches encounters a configuration that feeds back onto itself—where output from one circuit becomes input to another, which then reactivates the first—a self-sustaining loop forms. Whether this loop produces creative insight, autonomous problem-solving, or intrusive perseveration depends on its stability characteristics, informational content, and degree of inhibitory modulation.</p>

    <p>In favorable cases, these loops support exceptional abilities: mental music composition, mathematical problem-solving that occurs autonomously, creative pattern recognition emerging from persistent background processing. The same mechanism that produces intrusive loops can generate genuine insight when the loop engages content-rich associative pathways and remains open to external modulation. Conversely, when loops become rigid or engage circuits with high negative valence, they manifest as rumination, obsessive thought patterns, or perseveration.</p>
  ...
  <div id="tab-std" class="tab-panel">
    ...
    <p>Within the Distributed Pathway Model, stimming arises when concurrent activation across sensory, emotional, and cognitive circuits exceeds the capacity of inhibitory systems to contain it. This excess activation propagates through weakly gated branches connecting associative and emotional circuits to motor regions, producing spontaneous patterned movement. This isn't deliberate coping behavior—it's the brain's intrinsic response when internal activation exceeds containment capacity and finds an outlet through motor pathways.</p>

    <p>The movements are characteristically rhythmic and repetitive because motor circuits naturally form oscillatory patterns when driven by sustained input. Once initiated, these patterns persist through motor-sensory feedback loops: movement generates proprioceptive and tactile feedback, which reactivates motor pathways, sustaining the cycle. This is similar to central pattern generators in locomotion, but driven by overflow from cognitive-emotional load rather than locomotor intent.</p>
    ...
    <p>Reactive pathways aren't limited to motor output. When distributed propagation forms closed loops across auditory imagery, motor simulation, and associative regions, the result can be autonomous oscillators—persistent internal experiences running without volitional control. These include involuntary music loops persisting for hours or days, recursive thought patterns, spontaneous problem-solving continuing "in the background," and intrusive conceptual loops.</p>

    <p>These reflect the network finding stable dynamic equilibria within its own topology. When activation propagates through distributed branches and encounters a configuration that feeds back onto itself, a self-sustaining loop forms. Whether this produces creative insight, autonomous problem-solving, or intrusive perseveration depends on its stability characteristics, informational content, and degree of inhibitory modulation.</p>
  ...
  <div id="tab-gen" class="tab-panel">
    ...
    <p>Imagine a busy highway system where traffic is flowing through many interconnected routes. When traffic volume exceeds the system's capacity, cars start overflowing onto side roads, alternate routes, and eventually any available path. The overflow isn't intentional—it's just where traffic naturally goes when the main routes can't contain it all.</p>

    <p>Stimming works similarly. When your brain is processing a lot of sensory input, emotions, or thoughts simultaneously, all those neural signals create activation that spreads through many pathways. When this activation exceeds what your brain's "gating" systems can contain, it overflows into motor regions—the parts controlling movement. The result is spontaneous, repetitive motion.</p>

    <p>This explains why stimming increases when:</p>
    <ul>
      <li><strong>You're overwhelmed:</strong> More sensory input or emotional intensity means more neural activation seeking outlets</li>
      <li><strong>You're excited:</strong> Positive emotions create activation that also needs somewhere to go</li>
      <li><strong>You're concentrating hard:</strong> Intense cognitive effort fills neural pathways, and movement provides an outlet</li>
      <li><strong>You're anxious or uncertain:</strong> Emotional distress creates sustained activation without clear resolution</li>
    </ul>
    ...
    <p>The same mechanism that creates stimming can also create internal loops—patterns that run in your mind without conscious control:</p>

    <p><strong>Music loops:</strong> A song gets "stuck in your head" and plays repeatedly for hours or days. This happens when neural patterns for that music form a feedback loop—hearing it in your imagination reactivates the pathways that generate it, which makes you "hear" it again, which reactivates the pathways, and so on.</p>

    <p><strong>Thought loops:</strong> A particular thought pattern, problem, or conversation replay keeps running. You might mentally rehearse a conversation repeatedly, work on a problem in the background of your mind for days, or find certain ideas circling continuously.</p>

    <p><strong>Problem-solving that continues on its own:</strong> You think about a complex problem, then move on to other activities—but hours later, a solution suddenly appears. Your brain was still processing it in the background through sustained neural loops.</p>

    <p>Whether these loops are helpful or distressing depends on their content and stability:</p>
    <ul>
      <li><strong>Helpful loops:</strong> Working through creative problems, composing music mentally, developing complex ideas, recognizing patterns</li>
      <li><strong>Distressing loops:</strong> Ruminating on negative events, intrusive worries that won't resolve, obsessive thoughts, replaying mistakes</li>
    </ul>

    <p>These aren't separate from stimming—they're the same mechanism (sustained feedback loops) happening internally instead of through movement.</p>
    ...
    <p>Stimming is not:</p>
    <ul>
      <li>A bad habit to break</li>
      <li>Purposeless behavior</li>
      <li>Something to be ashamed of</li>
      <li>A sign of lack of control</li>
    </ul>
