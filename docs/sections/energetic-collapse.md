...
<div class="tabset">
  ...
  <div id="tab-gen" class="tab-panel">
    ...
    <ul>
      <li><strong>Can't speak or speaking becomes extremely difficult:</strong> The brain circuits for language production don't have energy to operate</li>
      <li><strong>Can't move or movement feels impossible:</strong> Motor circuits are offline</li>
      <li><strong>Can't process information:</strong> Thinking becomes slow or stops; you can't follow what's happening</li>
      <li><strong>Need to withdraw completely:</strong> Strong urge for darkness, quiet, being alone</li>
      <li><strong>Sensory shutdown:</strong> Everything feels muffled or distant</li>
      <li><strong>Inability to make decisions:</strong> Even simple choices feel impossible</li>
    </ul>

    <p><strong>This is not:</strong></p>
    <ul>
      <li>Being lazy or unmotivated</li>
      <li>Choosing to "shut down" emotionally</li>
      <li>Something you can "push through" with willpower</li>
      <li>A failure of emotional regulation</li>
    </ul>
    ...
    <ul>
      <li><strong>Intense emotional outbursts:</strong> Crying, anger, panic that feel completely uncontrollable</li>
      <li><strong>Physical agitation:</strong> Can't stay still, pacing, hand-flapping intensely</li>
      <li><strong>Sensory overwhelm:</strong> Everything feels too loud, too bright, too much</li>
      <li><strong>Loss of control:</strong> Might hit, throw things, or engage in behaviors you wouldn't normally do</li>
      <li><strong>Can't communicate:</strong> Unable to explain what's wrong or what you need</li>
    ...
    <ul>
      <li>Tantrums or attention-seeking</li>
      <li>Manipulative behavior</li>
      <li>Something you're choosing to do</li>
      <li>Lack of emotional control that could be fixed with "better coping skills"</li>
    </ul>

    <p><strong>Meltdowns are:</strong></p>
    <ul>
      <li>Involuntary neurological events</li>
      <li>Activation cascading faster than it can be contained</li>
      <li>Genuine loss of control due to system overload</li>
      <li>Extremely distressing for the person experiencing them</li>
    </ul>

    <h3>Why Collapse Happens at Different Times for Different People</h3>
    ...
    <ul>
      ...
      <li>Allow breaks before exhaustion hits</li>
      <li>Reduce sensory and cognitive load in the environment</li>
      <li>Accept that energy budgets are real biological limits</li>
    </ul>

    <p><strong>During shutdown:</strong></p>
    <ul>
      <li>Reduce all demands to absolute minimum</li>
      <li>Provide quiet, low-stimulation environment</li>
      <li>Don't expect communication or processing</li>
      <li>Understand this is biological, not behavioral</li>
      <li>Allow as much recovery time as needed</li>
    </ul>

    <p><strong>During meltdown:</strong></p>
    <ul>
      <li>Focus on safety (yours and theirs)</li>
